    ...
    <div class="container-fluid my-5">
        ...
        <div class="row justify-content-center my-5">
            <div class="col-7 bg-light border border-primary justify-content-center m-3">
                ...
                <form method="post" id="formRetirar" class=" mt-3">
                    <div class="form-row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select id="cuentas" class="form-control" name="" required>
                                    <option value="" disabled selected>Seleccione una cuenta de donde se retirara...</option>
                                </select>
                            </div>
                    ...
                    <input type="submit" class="btn btn-outline-primary my-2 float-right" value="Retirar" required>
                </form>
            </div>
